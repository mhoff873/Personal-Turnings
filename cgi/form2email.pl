...
my $HTML_thankyou            = 'http://www.personalturnings.com/thankyou.html';
my $to                       = 'mark@personalturnings.com';
my $from                     = 'mark@personalturnings.com';
my $mailprog                 = '/usr/sbin/sendmail';
my $subject                  = 'Question From Website';
##################################################################################
# 
...
my @required_fields          = (Name,Address,City,State,Zip);
my @required_fields_numbers  = (Zip);
